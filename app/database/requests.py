...
class Database:
    ...
    async def add_user(self, user_id: int, available_generations: int) -> None:
        """
    ...
    async def add_payment(self, user_id: int, amount_paid: int) -> None:
        """
        Добавляет платеж в БД
        :param user_id: ID пользователя
        :param amount_paid: Сумма платежа
        :return: None
        """
